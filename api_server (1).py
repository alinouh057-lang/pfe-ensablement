...
GDRIVE_ID    = '1Wjn-3rakaoMcLiQPYmpn2bh0-LgDQCoq'
IMG_SIZE     = 224
NUM_CLASSES  = 5
HISTORY_MAX  = 100
...
# ===== TÉLÉCHARGEMENT MODÈLE DEPUIS GOOGLE DRIVE =====
def download_model():
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  header { padding:20px 30px; border-bottom:1px solid var(--border);
    display:flex; justify-content:space-between; align-items:center; background:rgba(0,212,255,.03); }
  header h1 { font-size:1.2rem; font-weight:700; letter-spacing:2px; text-transform:uppercase; color:var(--accent); }
  .live { display:flex; align-items:center; gap:8px; font-family:'Share Tech Mono',monospace; font-size:.8rem; color:var(--green); }
  ...
  .stat { background:var(--card); border:1px solid var(--border); border-radius:12px; padding:20px; text-align:center; position:relative; overflow:hidden; }
  ...
  .card-title { font-size:.72rem; text-transform:uppercase; letter-spacing:2px; color:var(--muted); margin-bottom:15px; }
  ...
  .msg-box { padding:12px 16px; border-radius:8px; font-size:.88rem; text-align:center; margin-top:15px; font-weight:600; }
  ...
  th { text-align:left; color:var(--muted); font-size:.7rem; text-transform:uppercase; letter-spacing:1px; padding:8px 10px; border-bottom:1px solid var(--border); }
  ...
  footer { text-align:center; padding:15px; color:var(--muted); font-size:.72rem; border-top:1px solid var(--border); font-family:'Share Tech Mono',monospace; margin-top:20px; }
</style>
</head>
<body>
<header>
  ...
  <div class="grid-main">
    <div>
      <div class="card" style="margin-bottom:15px">
        ...
        <div class="msg-box" id="msg" style="background:rgba(0,255,136,.08);color:var(--green)">En attente de données...</div>
      </div>
      <div class="card">
    ...
    <div class="card">
      ...
      <tbody id="hist"><tr><td colspan="4" style="text-align:center;color:var(--muted);padding:30px">En attente de la première analyse...</td></tr></tbody></table>
    </div>
  </div>
</div>
